...
<!-- MJC TODO - Put in meta tags here (intentionally indented leftwise to stand out as a TO DO - realign/ remove when done-->
    ...
    <!-- MJC - Page header for Grameen - Navigation Bar  -->
    <!-- Custom styles for this template -->
    <link href="jumbotron.css" rel="stylesheet">

    <!-- MJC this from BStrap -->
  ...
  <body>
  <!-- MJC putting the Nav bar in the header as each page should have it -->
  <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            <span class="sr-only">Toggle navigation</span>
            <!-- MJC this turns the nav bar into the three horizontal Lines -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <!-- MJC - placeholders for other pages -->
 ...
 <!-- MJC buttons and input not needed, commenting out until ok to delete -->
